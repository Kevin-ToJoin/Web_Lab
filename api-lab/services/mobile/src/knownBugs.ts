...
export const KNOWN_BUGS: ApiBug[] = [
  {
    id: 'WALL-01',
    title: 'A payment without sufficient balance drives the wallet negative',
    area: 'Money',
    testType: 'Functional',
    characteristic: 'Functional correctness',
    testDesign: 'Boundary Value Analysis',
  ...
  {
    id: 'WALL-02',
    title: 'Balances stored/summed as float — money drifts by cents',
    area: 'Money',
    testType: 'Functional',
    characteristic: 'Functional correctness',
    testDesign: 'Boundary Value Analysis',
  ...
  {
    id: 'WALL-03',
    title: 'Concurrent taps race — the balance is double-spent (no lock)',
    area: 'Concurrency',
    testType: 'Non-functional',
    characteristic: 'Reliability',
    testDesign: 'Exploratory',
    testLevel: 'System',
  ...
  {
    id: 'WALL-04',
    title: 'A negative payment amount is accepted — it credits the wallet',
    area: 'Money',
    testType: 'Functional',
    characteristic: 'Input validation',
    testDesign: 'Boundary Value Analysis',
    testLevel: 'Contract',
  ...
  {
    id: 'WALL-05',
    title: 'The idempotency key is ignored — a retried tap charges twice',
    area: 'Money',
    testType: 'Functional',
    characteristic: 'Reliability',
    testDesign: 'State Transition',
    testLevel: 'Integration',
  ...
  {
    id: 'WALL-06',
    title: 'The daily spending limit is not enforced',
    area: 'Limits',
    testType: 'Functional',
    characteristic: 'Functional correctness',
    testDesign: 'Boundary Value Analysis',
  ...
  {
    id: 'WALL-07',
    title: 'No PIN is required above the contactless limit',
    area: 'Security',
    testType: 'Functional',
  ...
  {
    id: 'WALL-08',
    title: 'A missing transaction returns 200 with null instead of 404',
    area: 'HTTP / Contract',
    testType: 'Functional',
    characteristic: 'Functional correctness',
    testDesign: 'Error Guessing',
    testLevel: 'Contract',
  ...
  {
    id: 'WALL-09',
    title: 'Malformed body returns a 500 HTML stack trace instead of 400',
    area: 'HTTP / Contract',
    testType: 'Functional',
    characteristic: 'Reliability',
    testDesign: 'Equivalence Partitioning',
    testLevel: 'Contract',
  ...
  {
    id: 'WALL-10',
    title: 'PII leak / IDOR — GET /wallets/:id returns the full card number (PAN)',
    area: 'Security',
    testType: 'Non-functional',
    characteristic: 'Security',
    testDesign: 'Exploratory',
  ...
  {
    id: 'WALL-11',
    title: '/admin/wallets has no authorization and exposes every card number',
    area: 'Security',
    testType: 'Non-functional',
    characteristic: 'Security',
    testDesign: 'Exploratory',
  ...
  {
    id: 'WALL-12',
    title: 'A payment can be reversed twice — the refund double-credits',
    area: 'Money',
    testType: 'Functional',
    characteristic: 'Functional correctness',
    testDesign: 'State Transition',
